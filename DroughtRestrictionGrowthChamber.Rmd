...
Here we analyzed growth chamber under water restriction
...
load dataset
```{r}
photosynq <- read.csv("/Users/lau/Desktop/AU_research/Old_Rotation/Jan2022/Growthchamberexp/growthchamberalldata/growthchamberphotosinq05.01.22.csv", na.strings = "na")
str(photosynq)
```

We didn't work with treatment NVP5
```{r}
minNVP5 <-  photosynq %>%
